...
# Cargar diccionario
ruta_diccionario = r"E:\Aplicaciones\Nuevo_PRG\Diccionarios\Dict_new_BESS.xlsx"
dict_bess = pd.read_excel(ruta_diccionario, sheet_name="Hoja1")
...
def obtener_datos(sol_file, tipo_solucion: str, st_schedule, hini, hfin):
    ...
    horas = [str(h) for h in range(1, 49)]
...
def Query_new_BESS(sol_file, tipo_solucion: str,st_schedule, hini, hfin):
    ...
    inyeccion_datos, df_charge_gen, df_charge_grid = obtener_carga_gen_grid(sol_file, tipo_solucion, True, hini, hfin)
    ...
    return  df_charge_gen, df_charge_grid, perfil_completo